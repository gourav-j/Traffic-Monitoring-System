...
public class MapsActivity extends FragmentActivity implements OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ImageButton buttonCurrent=(ImageButton)findViewById(R.id.buttonCurrent);
        ImageButton buttonSave=(ImageButton)findViewById(R.id.buttonSave);
        ImageButton buttonView=(ImageButton)findViewById(R.id.report);
    ...
    public void onClick(View v) {
        switch (v.getId()){
            ...
            case R.id.buttonSave:
                ...
                break;
            case R.id.report:
                Intent r = new Intent(this, Report.class);
                startActivity(r);
                break;
            case R.id.search:
